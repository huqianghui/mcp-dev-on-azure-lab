...
def translate(message: str) -> str:
    return f'Please translate the following text into Chinese:\n\n{message}'
...
def translate(message: str) -> str:
    return f'Please translate the following text into English:\n\n{message}'
...
def get_greeting(name: str) -> str:
    # Handle greeting://{name} resource protocol and return
    return f"Hello, {name}!"
